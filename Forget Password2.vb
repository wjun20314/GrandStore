...
Public Class Forget_Password2
    ...
    Dim hhuid As String
    Dim hhemail As String

    Private Sub Forget_Password2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        temp = MainMenu.mmsid
        hhsid = temp
        temp = MainMenu.mmsname
        hhname = temp
        temp = MainMenu.mmuid
        hhuid = temp
        temp = MainMenu.mmemail
        hhemail = temp
    ...
    Private Sub btnReqCode_Click(sender As Object, e As EventArgs) Handles btnReqCode.Click
        ...
        Dim bodymsg As String = "Hi " & hhname + ",</br></br>" & "This is your security code " & longcharacter &
        ...
        Else
            ...
            cmd = New SqlCommand("UPDATE Staff set securityCode=@sccode WHERE sID=@staffid", conn)
            cmd.Parameters.AddWithValue("@sccode", longcharacter)
            cmd.Parameters.AddWithValue("@staffid", ctrSID)
            cmd.ExecuteNonQuery()

            getMail.sendMail("redplusclinic@gmail.com", hhemail, "Security Code", bodymsg)
